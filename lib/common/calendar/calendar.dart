...
class TableCalendar extends StatefulWidget {
  ...
  final HeaderStyle headerStyleMM;
  ...
  TableCalendar({
    ...
    this.headerStyleMM = const HeaderStyle(),
    ...
    final children = [
      ...
      Padding(
        ...
        child: GestureDetector(
          ...
          child: Container(
            width: widget.titleStatus ?140:100,
            child: Row(
                        ...
                        widget.headerStyle.titleTextBuilder != null
                            ...
                            : ". " +
                                DateFormat.y(widget.locale)
                                    .format(widget.calendarController.focusedDay),
                        style: weekdaySupStyle,
                        // style: widget.headerStyleMM.titleSupTextStyle,
                        textAlign: widget.headerStyle.centerHeaderTitle
                            ? TextAlign.center
                            : TextAlign.start,
                      )
